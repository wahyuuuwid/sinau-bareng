<x-layout.app title="Dashboard Dosen" class="bg-[#F4F4F4]">
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            ...
            {{-- Sapaan Dinamis --}}
            <h2 class="text-xl font-medium text-gray-800 mb-6 font-semibold">
            ...
            <div class="grid grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-8 rounded-2xl flex justify-between items-center shadow-sm">
                    <div>
                        <p class="text-gray-700 font-semibold mb-1">Materi Menunggu Validasi</p>
                        <p class="text-3xl font-bold">{{ $countMenunggu }}</p>
                    </div>
                ...
                <div class="bg-white p-8 rounded-2xl flex justify-between items-center shadow-sm">
                    <div>
                        <p class="text-gray-700 font-semibold mb-1">Soal AI Menunggu Validasi</p>
                        <p class="text-3xl font-bold">{{ $countSoalAI }}</p>
                    </div>
                ...
                <div class="bg-white p-8 rounded-2xl flex justify-between items-center shadow-sm">
                    <div>
                        <p class="text-gray-700 font-semibold mb-1">Sudah Disetujui</p>
                        <p class="text-3xl font-bold">{{ $countDisetujui }}</p>
                    </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="text-sm">
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="p-8 text-center text-gray-500 italic">Belum ada materi yang perlu divalidasi.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
