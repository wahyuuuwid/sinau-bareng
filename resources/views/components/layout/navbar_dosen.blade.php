<header class="flex justify-between items-center w-full mb-8 font-['Poppins']">
    
    {{-- Bagian Kiri: Diisi dinamis oleh halaman (Slot) --}}
    <div class="flex-1">
        {{ $slot }}
    </div>
    ...
    <div class="flex items-center ml-auto">
        ...
        @php
            // Mengambil notifikasi milik dosen yang belum dibaca
        ...
        <div class="relative group inline-block z-50">
            ...
            <div class="absolute right-0 mt-3 w-80 bg-white border border-gray-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 overflow-hidden transform origin-top-right scale-95 group-hover:scale-100">
                    ...
                    @forelse($unreadNotifs as $notif)
                        <div class="p-4 border-b border-gray-50 hover:bg-indigo-50/50 transition-colors cursor-pointer group/item">
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 rounded-full flex-shrink-0 bg-blue-100 text-blue-600 flex items-center justify-center">
